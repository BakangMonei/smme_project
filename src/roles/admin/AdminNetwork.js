...
const AdminNetwork = () => {
  ...
  return (
    <div className="container mx-auto w-96 p-4">
      <h1 className="text-4xl font-bold mb-4 text-center border-b-2">
        Add Network
      </h1>
      <div className="bg-white rounded-lg shadow-md p-4">
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="Digital Marketing And E-Commerce">
              Digital Marketing And E-Commerce
            </option>
            <option value="Business and Entrepreneurship">
              Business and Entrepreneurship
            </option>
            <option value="Finance and Investment">
              Finance and Investment
            </option>
            <option value="Healthcare and Wellness">
              Healthcare and Wellness
            </option>
            <option value="Manufacturing and Product Development">
            ...
            <option value="Retail and Merchandising">
            ...
            <option value="Non-profit and Social Enterprises">
              Non-profit and Social Enterprises
            </option>
            <option value="Real Estate and Property Management">
              Real Estate and Property Management
            </option>
            <option value="Farming and Agricultural Practices">
