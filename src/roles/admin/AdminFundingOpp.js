...
function AdminFundingOpp() {
  ...
  return (
    <div className="bg-white w-96 h-screen p-4 rounded-lg shadow-md mx-auto">
      <div className="text-black text-4xl font-bold font-sans border-b-2 text-center">
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, name: e.target.value })
          }
        />
      </div>
      <div className="flex flex-col mt-4">
        ...
        <textarea
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, information: e.target.value })
          }
        />
      </div>
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, contacts: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, website: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, photo: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, country: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, minAmount: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, maxAmount: e.target.value })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({
              ...newFundingOpp,
              eligibleSectors: e.target.value,
            })
          }
        />
      </div>
      ...
      <div className="flex flex-col mt-4">
        ...
        <input
          ...
          onChange={(e) =>
            setNewFundingOpp({ ...newFundingOpp, applyHere: e.target.value })
          }
        />
      </div>
      ...
      <div className="mt-6 flex justify-center">
        <button
          className="bg-blue-500 rounded-xl border border-cyan-400  w-1/4 py-2 text-white font-bold"
          onClick={addFundingOppToFirestore}
        >
          ADD
        </button>
      </div>
